...
// Importação de extrato por arquivo (OFX) + preview da planilha de conciliação.
// O cadastro de contas/cartões fica em Contas a Pagar › Contas bancárias
// (ContasBancariasTab); aqui só se lê as contas já cadastradas.
...
export function ConciliacaoPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {/* Contas e cartões moraram aqui como aba; agora vivem em Contas a Pagar ›
          Contas bancárias (ContasBancariasTab). A conciliação segue lendo as
          mesmas contas. */}
      <div className="space-y-4">
          {accounts.length === 0 ? (
            <div className="bg-card border border-border rounded-xl p-8 text-center text-text-light text-sm">
              Cadastre uma conta bancária em <b>Contas a Pagar › Contas bancárias</b> antes de importar o extrato.
            </div>
          ) : (
            <>
