  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <button
          onClick={() => { loadDashboard(); fetchDollar(); }}
          className="self-start px-3 py-1.5 text-xs text-text-light hover:text-text hover:bg-gray-100 rounded-lg border border-border transition flex items-center gap-1"
        >
